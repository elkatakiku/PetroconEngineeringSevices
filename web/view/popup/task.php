            ...
            <form id="taskForm">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" rows="1"
                              ...
                              style="min-height: 1rem; height: 34px; overflow-y: hidden;" required></textarea>
                </div>

                <div class="form-group">
                    <label>Duration</label>
                    <div class="linear">
                        <input type="date" class="form-control" name="start" data-start="taskDuration"
                               min="<?= $data["completion"]['start'] ?>" max="<?= $data["completion"]['end'] ?>"
                               required>
                        -
                        <input type="date" class="form-control" name="end" data-end="taskDuration"
                               min="<?= $data["completion"]['start'] ?>" max="<?= $data["completion"]['end'] ?>"
                               required>
                    </div>
                </div>
