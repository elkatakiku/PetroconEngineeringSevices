<div class="cover-background" data-image="header-image.jpg">
    <div class="cover-page center-grid">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-6 col-12">
                <form class="form-login" action="<?= SITE_URL ?>/login/run" method="post">
                    ...
                    <a href="<?= SITE_URL ?>/signup" id="createAccountBtn" class="btn outline-primary-btn btn-block" data-toggle="popup" data-target="#popupsignUp">Create an account</a>
                </form>
            </div>
        </div>
    </div>
