        ...
        <form class="cover-form p-4" action="<?= SITE_URL . '/auth/resetPassword' ?>" method="POST">
            ...
            <?php if (!isset($_GET['success'])) { ?>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="passwordRepeat" data-validate="passwordRepeat"
                           required>
                </div>
            ...
            <a href="<?= SITE_URL ?>"
               class="btn btn-block <?php echo isset($_GET['success']) ? 'action-btn' : 'link-btn'; ?>">Go to login</a>
        </form>
    </div>
</div>