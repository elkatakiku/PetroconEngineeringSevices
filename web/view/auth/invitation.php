            ...
            <?php if (!$data['expired']) { ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="password" readonly
                           value="<?= $data['invitation']['username'] ?>">
                </div>

                <div class="form-group">
                    <label for="">Password</label>
                    <input type="text" class="form-control" name="password" readonly
                           value="<?= $data['invitation']['password'] ?>">
                </div>

                <div class="alert alert-info show">
                    This is your only way to access your account. <strong>Save your login credentials</strong> or change
