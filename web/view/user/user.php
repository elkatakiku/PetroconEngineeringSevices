        ...
        <div id="userProfile" class="main-content custom-tab-content show">
            <div class="fluid-container">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn primary-btn slim-btn danger-btn" id="deleteAccount"> Delete
                        Account
                    </button>
                </div>
                            ...
                            <td>
                                <div class="dropdown ml-auto">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg-right">
                                        <button class="dropdown-item" type="button" data-toggle="popup"
                                                data-target="#removefromJoined" aria-expanded="false"> Remove
                                        </button>
                                    </div>
                                </div>
                            </td>
                            <!-- remove from joined  Popup -->
                            <div class="popup popup-center popup-delete" id="removefromJoined" tabindex="-1"
                                 aria-hidden="true">
                                <div class="pcontainer popup-sm">
                                    <div class="pcontent">
                                        <div class="pheader">
                                        ...
                                        <div class="pfooter">
                                            ...
                                            <button type="button" class="btn link-btn" data-dismiss="popup">Cancel
                                            </button>
                                        </div>
                                    </div>
                                </div>
