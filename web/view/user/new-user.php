...
<main class="content">
            ...
            <div class="linear">
                <div class="personal-form basis-lg-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control top" name="firstname" id="firstName" aria-describedby="helpId" placeholder="Enter first name" required>
                    </div>

                    <div class="form-group">
                        <label for="middlename">Middle Name</label>
                        <input type="text" class="form-control top" name="middlename" id="middlename" aria-describedby="helpId" placeholder="Enter first name">
                    </div>
                ...
                <div class="account-form basis-lg-4">
                    ...
                    <!-- <div class="form-group">
                      ...
                      <select class="form-control" name="position" id="position">
                        ...
                        <option value="">Technical, Fire & Protection Equipment</option>
                        <option value="">Piping Foreman</option>
                        <option value="">Admin Officer</option>
                        <option value="">Electrical & Aircon Technician</option>
                        <option value="">Skilled</option>
                        <option value="">Laborer</option>
                      </select>
                    </div> -->
    ...
    <div class="page-footer">
        ...
        <a href="<?= SITE_URL.'/user/list#all' ?>"><button type="button" class="btn outline-action-btn">Cancel</button></a>
    </div>            
</main>
